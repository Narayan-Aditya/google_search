...
6. Watch the **live status/log** in the popup — current city, current page,
...
- Come back to the popup and click **Resume** — it re-loads the same page it
...
- **Progress survives popup close**: closing the popup doesn't stop the run;
  it keeps going in the background tab. Reopen the popup any time to see
  where it's at.
...
| `popup/` | The popup UI (HTML/CSS/JS) |
